...
export default function Automations() {
  ...
  const [form, setForm] = useState({ name: '', description: '', client_id: '', category: 'whatsapp', n8n_workflow_url: '', assigned_to: '', priority: 'medium' });
  ...
  const createFlow = useMutation({
    ...
    onSuccess: () => {
      ...
      setNewOpen(false);
      setForm({ name: '', description: '', client_id: '', category: 'whatsapp', n8n_workflow_url: '', assigned_to: '', priority: 'medium' });
    },
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Gerencie fluxos de automação e chatbots (n8n)</p>
        </div>
          ...
          {COLUMNS.map(col => {
            ...
            return (
              <div key={col.status} className="min-w-[220px]">
                ...
                <div className="border rounded-b-lg p-2 space-y-2 min-h-[200px] bg-card">
                  {colFlows.map(flow => (
